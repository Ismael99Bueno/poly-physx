...
class quad_tree_broad2D final : public broad_phase2D
{
  ...
  private:
    ...
    void detect_collisions_st(const std::vector<qtpartition> &partitions);
    void detect_collisions_mt(const std::vector<qtpartition> &partitions);
