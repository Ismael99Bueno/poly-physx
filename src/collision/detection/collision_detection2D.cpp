                                                          ...
                                                          collision2D *colis) const
{
    ...
    *colis = {m_world->bodies.ptr(body1.index), m_world->bodies.ptr(body2.index), contact1, contact2, mtv};
    return true;
}
                                                         ...
                                                         collision2D *colis) const
{
    ...
    *colis = {m_world->bodies.ptr(body1.index), m_world->bodies.ptr(body2.index), contact1, contact2, mtv.value()};
...
{
    body1.events.try_exit(m_world->bodies.ptr(body1.index), m_world->bodies.ptr(body2.index));
    body2.events.try_exit(m_world->bodies.ptr(body2.index), m_world->bodies.ptr(body1.index));
}
